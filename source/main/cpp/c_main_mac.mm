                ...
                switch (nsEvent.type)
                {
                    ...
                    case NSEventTypeKeyDown:
                    {
                        ...
                        if ([characters length] > 0)
                        {
                            ...
                            {
                                case 'a':
                                case 'A': d = Key::A; break;
                                case 'b':
                                case 'B': d = Key::B; break;
                                default: break;
                            }
                        }
                        ...
                        {
                            case 0x7B: d = Key::Left; break;
                            case 0x7C: d = Key::Right; break;
                            default: break;
                        }
                    ...
                    case NSEventTypeLeftMouseDown:
                        curEvent = Event(MouseInputData(
                          ...
                          nwindow::ModifierState(nsEvent.modifierFlags & NSEventModifierFlagControl, nsEvent.modifierFlags & NSEventModifierFlagOption, nsEvent.modifierFlags & NSEventModifierFlagShift, nsEvent.modifierFlags & NSEventModifierFlagCommand)));
                        break;
                    ...
                    case NSEventTypeMouseMoved:
                        curEvent = nwindow::Event(nwindow::MouseMoveData(static_cast<unsigned int>(nsEvent.absoluteX), static_cast<unsigned int>(nsEvent.absoluteY), static_cast<unsigned int>(nsEvent.absoluteX), static_cast<unsigned int>(nsEvent.absoluteY),
                                                                         static_cast<int>(nsEvent.deltaX), static_cast<int>(nsEvent.deltaY)));
                        break;
                    case NSEventTypeScrollWheel: [nsEvent deltaY]; break;
                    default: break;
                }
